      ...
      <section style={{}}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "60px" }}>
            ...
            >
              At Tizaraa, caring means creating a marketplace where vendors
              thrive, customers trust, and communities prosper
            </p>
          </div>
      ...
      <section>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "60px" }}>
            ...
            >
              Our dedicated care team is here to help you succeed. Get in touch
              with us through any of these channels.
            </p>
          </div>
