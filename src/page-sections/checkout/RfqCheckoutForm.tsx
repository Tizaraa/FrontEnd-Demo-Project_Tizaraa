...
const RfqCheckoutForm: FC<RfqCheckoutFormProps> = ({ responseId }) => {
 ...
 const handlePayment = async () => {
  ...
  try {
   ...
   toast.error(
    "Your order could not be placed because an order with this vendor response ID already exists. Please check your order details and try again."
   );
  }
 };
