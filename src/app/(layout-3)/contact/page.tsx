  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        height: "300px",
        borderRadius: "50%",
        background: "radial-gradient(circle, rgba(233,69,96,0.08) 0%, rgba(233,69,96,0) 70%)",
        zIndex: 0
      }}></div>
      ...
      >
        ...
        >
          {[
            { label: "Name", name: "name", type: "text", placeholder: "Your Name", value: formState.name },
            { label: "Phone Number", name: "phone", type: "tel", placeholder: "Your Phone Number", value: formState.phone },
            { label: "Email Address", name: "email", type: "email", placeholder: "Your Email Address", value: formState.email },
          ].map((input, idx) => (
        ...
        >
            ...
            {[
              {
                ...
                title: "Email Us",
                content: (
                  <a href="mailto:info@tizaraa.com" style={{ 
                    textDecoration: "none", 
                    color: "#495057",
              ...
              },
              {
                icon: faLocationDot,
                title: "Our Location",
                content: <p style={{ margin: 0, color: "#495057" }}>Ga. 131/1, Middle Badda, Dhaka - 1212, Bangladesh</p>,
              },
              {
                icon: faPhone,
                title: "Call Us",
                content: (
                  <a href="tel:+8801792223444" style={{ 
                    textDecoration: "none", 
                    color: "#495057",
                    transition: "color 0.3s ease",
                  }}
              ...
              >
                ...
                <div>
                  <h4 style={{ margin: "0 0 5px 0", fontSize: "16px", color: "#343a40" }}>{item.title}</h4>
                  {item.content}
                </div>
              </div>
            ))}
          ...
          <div style={{
            ...
            <div style={{ display: "flex", gap: "15px" }}>
              {[
                { icon: faFacebook, color: "#3b5998", url: "https://www.facebook.com/TizaraaGroup" },
                { icon: faInstagram, color: "#E1306C", url: "https://www.instagram.com/tizaraagroup/?igsh=MXB1b2l1NXN6N2U5dQ%3D%3D#" },
                { icon: faYoutube, color: "#FF0000", url: "https://www.youtube.com/@Tizaraa24" },
              ].map((social, idx) => (
                <a 
                  key={idx}
                  href={social.url} 
