      ...
      <Box position="relative" flex="1 1 0" maxWidth="670px" mx="auto">
       ...
       >
        <Autocomplete
         ...
         value={
          provinces.find((p) => p.id === parseInt(selectedProvince)) || null
         }
         onChange={(event, value) =>
          handleProvinceChange({ target: { value: value ? value.id : "" } })
         }
         renderInput={(params) => (
        ...
        <Autocomplete
         ...
         onChange={(event, value) =>
          handleCityChange({ target: { value: value ? value.id : "" } })
         }
         renderInput={(params) => (
        ...
        <Autocomplete
         ...
         onChange={(event, value) =>
          handleAreaChange({ target: { value: value ? value.id : "" } })
         }
         renderInput={(params) => (
