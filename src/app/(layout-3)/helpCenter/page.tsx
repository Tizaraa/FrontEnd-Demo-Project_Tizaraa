    ...
    <div style={styles.container}>
     ...
     <div style={styles.contactingWrapper}>
      <div style={styles.contacting}>
       ...
       <p>
        <strong>Saturday - Thursday:</strong> 9:00 AM - 6:00 PM (Your Time Zone)
        <br />
      ...
      <div style={styles.contacting}>
       ...
       <p>
        Explore our Customer Service FAQs for quick answers to common inquiries
     ...
     <div style={styles.btSection}>
      <div style={styles.contacting}>
       ...
       <p>
        Join the Tizaraa Community Forum to connect with other users, share
        experiences, and get advice. Our moderators and community members are
        active, and you might find answers to your questions there.
       </p>
      </div>
      <div style={styles.contacting}>
       <img
       ...
       <p>
        ...
        services or encounter any issues, please let us know through our
        Feedback Form.
       </p>
      </div>
     </div>
