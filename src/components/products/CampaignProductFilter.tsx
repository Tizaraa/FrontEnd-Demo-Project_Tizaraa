...
type CampaignProductFilterProps = {
...
const CampaignProductFilter: React.FC<CampaignProductFilterProps> = ({
 onBrandChange,
 onCategoryChange,
 onCountryChange,
 onProvinceChange,
 ...
 return (
  <Card style={cardStyle}>
   ...
   <FilterSection
    ...
    onClickHandler={(id) =>
     handleFilterClick(id, selectedBrands, setSelectedBrands, onBrandChange)
    }
   ...
   <FilterSection
    ...
    onClickHandler={(id) =>
     handleFilterClick(id, selectedCountry, setSelectedCountry, onCountryChange)
    }
...
export default CampaignProductFilter;
