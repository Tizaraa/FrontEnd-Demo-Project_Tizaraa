        ...
        {isPasswordPage ? (
          ...
          <>
            ...
            <div style={styles.textContent}>
              ...
              <p style={styles.subtitle}>
                We've sent a 6-digit code to your {verificationMethod === "email" ? "email address" : "phone number"}.
              </p>
            </div>
            ...
            <div style={styles.timer}>
              {isTimerActive ? (
                ...
                <p style={styles.timerExpired}>Code has expired. Please request a new one.</p>
              )}
            </div>
          </>
        ) : (
