...
//             toast.error("OTP has expired! Please resend the OTP"); // Show toast when timer expires
//             return 0;
//           }
...
//           response.data.phone || "No phone number available"
//         );
//       } catch (error) {
//         console.error("Error fetching phone number:", error);
//       }
...
//     if (newPhoneNumber === currentPhoneNumber) {
//       setErrorMessage(
//         "New phone number cannot be the same as the current number."
//       );
//       return;
//     }
...
//             <p style={{ fontSize: "0.875rem" }}>
//               To verify your account, we have sent a One Time Password (OTP) to
//               your phone number. Please check your phone. Thank you!
//             </p>
...
//                 {resendTimer > 0 ? (
//                   <span style={{ color: "#2563eb" }}>
//                     OTP expires in {Math.floor(resendTimer / 60)}:
...
//   // New state to control the expiry message visibility
...
//           // Show expiry message when timer reaches 0
//           if (newTimer === 0) {
...
//                 Enter OTP &nbsp;
//               </label>
//               {/* Conditionally show expiry message */}
//               {showExpiryMessage && (
//                 <span style={{color: 'red', fontWeight: '400', fontStyle: 'italic'}}>
//                   - Your OTP Already Expired! Please Click Resend OTP Button
//                 </span>
//               )}
//               <TextField
//                 id="otp"
   ...
   >
    ...
    >
     ...
     >
      ...
      <p style={{ fontSize: "0.875rem" }}>
       To verify your account, we have sent a One Time Password (OTP) to your
       phone number. Please check your phone. Thank you!
      </p>
      ...
      >
       ...
       {/* Show error message only if OTP is not exactly 6 digits */}
       {otp.length !== 6 && (
        <span
         style={{
          marginBottom: "12px",
