...
//   const [selectedCategory, setSelectedCategory] = useState<string | null>(slug); // Initialize with slug
...
//     setSelectedCategory(category); // Update category without navigation
//     setCurrentPage(1);
//   };
...
//         // Clear products if no data is available
//         if (currentPage === 1) {
//           setProducts([]);
//         }
//         // Do not append previous products
//       } else {
//         // Append or replace based on page
//         if (currentPage === 1) {
//           setProducts(data.data);
