...
const ProductDetails = ({
  ...
  const selectedBulkPrice =
    selectedB2BProduct?.bulk_pricing
      ...
      .find((bp) => parseInt(bp.min_quantity) <= effectiveQuantity)
      ?.unit_price || displayPrice;
