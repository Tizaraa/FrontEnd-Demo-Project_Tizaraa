   ...
   <main>
    ...
    <div style={{ padding: "20px", maxWidth: "1200px", margin: "0 auto" }}>
     <div>
      <h4>INTRODUCTION</h4>
      <p>
       Welcome to Tizaraa! Our community is built on trust, respect, and
       collaboration. To ensure a positive experience for everyone, we have
       established this Code of Conduct that outlines the standards and behavior
       expected from all members of the Tizaraa community, including buyers,
